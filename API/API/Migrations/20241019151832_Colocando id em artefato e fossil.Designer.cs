...
namespace API.Migrations
{
    ...
    [Migration("20241019151832_Colocando id em artefato e fossil")]
    partial class Colocandoidemartefatoefossil
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Models.Artefato", b =>
                {
                    b.HasOne("API.Models.Arqueologo", "Arqueologo")
                        .WithMany()
                        .HasForeignKey("ArqueologoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Arqueologo");
                });

            modelBuilder.Entity("API.Models.Fossil", b =>
                {
                    b.HasOne("API.Models.Paleontologo", "Paleontologo")
                        .WithMany()
                        .HasForeignKey("PaleontologoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Paleontologo");
                });
